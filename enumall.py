...
def run_recon(domains, bruteforce):
	...
	shodankey = os.environ['shodan_api']
	googleapikey = os.environ['google_api']
	googlecsekey = os.environ['google_cse']

	reconb = base.Recon(base.Mode.CLI)
	reconb.init_workspace(wspace)
	reconb.onecmd("TIMEOUT=100")
	reconb.onecmd("keys add shodan_api 39Vjh03Crbi0EoPzwSffZAxcNLFqwed1")
	reconb.onecmd("keys add google_api AIzaSyDUDMi_kuJsoG53Fbxst7Ccpd592TbCwK4")
	reconb.onecmd("keys add google_cse 016872495654316171864:wtvyugugj0g")
	...
	x.do_set("FILENAME " + os.environ['enumallfile'])
